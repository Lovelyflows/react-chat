...
declare const _default: React.FC<ChatWidgetProps> & {
    ...
    Container: import('@voiceflow/stitches-react/types/styled-component').StyledComponent<(props: React.DetailedHTMLProps<React.HTMLAttributes<HTMLDivElement>, HTMLDivElement>) => React.ReactElement<any, string | React.JSXElementConstructor<any>>, {
        withChat?: boolean | "true" | "false" | undefined;
        isHidden?: boolean | "true" | undefined;
    }, {
        mobile: string;
    ...
    ChatContainer: import('@voiceflow/stitches-react/types/styled-component').StyledComponent<(props: React.DetailedHTMLProps<React.HTMLAttributes<HTMLDivElement>, HTMLDivElement>) => React.ReactElement<any, string | React.JSXElementConstructor<any>>, {}, {
        mobile: string;
    }, import('@voiceflow/stitches-react/types/css-util').CSS<{
        mobile: string;
    }, {
    ...
    LauncherContainer: import('@voiceflow/stitches-react/types/styled-component').StyledComponent<(props: React.DetailedHTMLProps<React.HTMLAttributes<HTMLDivElement>, HTMLDivElement>) => React.ReactElement<any, string | React.JSXElementConstructor<any>>, {}, {
        mobile: string;
    }, import('@voiceflow/stitches-react/types/css-util').CSS<{
        mobile: string;
    }, {
