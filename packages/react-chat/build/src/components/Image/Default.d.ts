...
export declare const tag: {
    ...
    <Props>(component: import('react').ComponentType<Props>, suffix?: string | undefined): (props: Props) => import('react').ReactElement<any, string | import('react').JSXElementConstructor<any>>;
};
export declare const DefaultImageBase: import('@voiceflow/stitches-react/types/styled-component').StyledComponent<(props: import('react').DetailedHTMLProps<import('react').ImgHTMLAttributes<HTMLImageElement>, HTMLImageElement>) => import('react').ReactElement<any, string | import('react').JSXElementConstructor<any>>, {
    isRounded?: boolean | "true" | undefined;
    mode?: "overlay" | "embedded" | undefined;
}, {
    mobile: string;
...
declare const _default: import('react').FC<DefaultImageProps> & {
    Base: import('@voiceflow/stitches-react/types/styled-component').StyledComponent<(props: import('react').DetailedHTMLProps<import('react').ImgHTMLAttributes<HTMLImageElement>, HTMLImageElement>) => import('react').ReactElement<any, string | import('react').JSXElementConstructor<any>>, {
        isRounded?: boolean | "true" | undefined;
        mode?: "overlay" | "embedded" | undefined;
    }, {
        mobile: string;
