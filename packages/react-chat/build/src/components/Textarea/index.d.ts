 ...
 */
declare const _default: ForwardRefExoticComponent<TextareaProps & RefAttributes<HTMLTextAreaElement>> & {
    Controlled: import('react').FC<import('../../utils/controls').ControlledProps<ControlProps<any>>>;
    Container: import('@voiceflow/stitches-react/types/styled-component').StyledComponent<ForwardRefExoticComponent<TextareaAutosizeProps & RefAttributes<HTMLTextAreaElement>>, {}, {
        mobile: string;
