...
export declare const textareaUniqueStyles: CSS;
export declare const textareaStyles: CSS;
export declare const textareaFocusStyles: CSS;
export declare const Container: import('@voiceflow/stitches-react/types/styled-component').StyledComponent<import('react').ForwardRefExoticComponent<import('react-textarea-autosize').TextareaAutosizeProps & import('react').RefAttributes<HTMLTextAreaElement>>, {}, {
    mobile: string;
