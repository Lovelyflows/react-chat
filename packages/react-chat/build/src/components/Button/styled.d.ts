...
export declare const Reset: import('@voiceflow/stitches-react/types/styled-component').StyledComponent<"button", {}, {
    mobile: string;
...
export declare const Container: import('@voiceflow/stitches-react/types/styled-component').StyledComponent<(props: Omit<Omit<import('react').DetailedHTMLProps<import('react').ButtonHTMLAttributes<HTMLButtonElement>, HTMLButtonElement>, "ref"> & {
