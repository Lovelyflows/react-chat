...
export declare const CloseContainer: import('@voiceflow/stitches-react/types/styled-component').StyledComponent<(props: React.DetailedHTMLProps<React.HTMLAttributes<HTMLDivElement>, HTMLDivElement>) => React.ReactElement<any, string | React.JSXElementConstructor<any>>, {}, {
    mobile: string;
...
declare const Close: React.FC<React.ComponentProps<typeof CloseContainer>>;
