        ...
        case "split_node": {
          if (Path.equals(op.path, path)) {
            if (op.position === offset && affinity == null) {
              ...
              p2.offset -= op.position;
              p2.path = Path.transform(path, op, _objectSpread$b(_objectSpread$b({}, options), {}, {
                affinity: "forward"
              }));
            }
          } else {
...
// ../../node_modules/@voiceflow/slate-serializer/build/esm/guards.mjs
init_esm();
var isLinkElement = (element) => element.type === text_exports.ElementType.LINK;
var isVariableElement = (element) => element.type === text_exports.ElementType.VARIABLE;
...
//# sourceMappingURL=chunk-AIS4AKX6.js.map
