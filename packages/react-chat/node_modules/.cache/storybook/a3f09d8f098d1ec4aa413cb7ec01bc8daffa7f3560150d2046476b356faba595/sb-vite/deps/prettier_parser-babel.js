  ...
  "../../node_modules/prettier/plugins/babel.js"(exports, module) {
    (function(f) {
      ...
      var Hs = (a, t) => () => (t || a((t = { exports: {} }).exports, t), t.exports), Ws = (a, t) => {
        for (var e in t)
          Se(a, e, { get: t[e], enumerable: true });
      }, kt = (a, t, e, s) => {
        if (t && typeof t == "object" || typeof t == "function")
          for (let i of qs(t))
            !Ks.call(a, i) && i !== e && Se(a, i, { get: () => t[i], enumerable: !(s = Vs(t, i)) || s.enumerable });
        return a;
      };
        ...
        var Ye = class extends Ge {
          ...
          finalizeComment(t) {
            ...
            if (t.leadingNode !== null || t.trailingNode !== null)
              t.leadingNode !== null && es(t.leadingNode, e), t.trailingNode !== null && Ii(t.trailingNode, e);
            else {
        ...
        function Ut(a, t, e, s, i, r) {
          ...
          for (; ; ) {
            ...
            if (d === 92) {
              ...
              d === 8232 || d === 8233 ? (++e, ++i, s = e) : d === 10 || d === 13 ? a === "template" ? (c += t.slice(u, e) + `
...
`);
        ...
        function is(a, t, e, s, i, r) {
          ...
          if (n === 123) {
            if (++t, { code: o, pos: t } = Ze(a, t, e, s, a.indexOf("}", t) - t, true, i, r), ++t, o !== null && o > 1114111)
              if (i)
                r.invalidCodePoint(t, e, s);
              else
                return { code: null, pos: t };
          } else
            ({ code: o, pos: t } = Ze(a, t, e, s, 4, false, i, r));
          return { code: o, pos: t };
        }
        function ce(a, t, e) {
        ...
        var Di = /* @__PURE__ */ new Set([103, 109, 115, 105, 121, 117, 100, 118]), O = class {
          ...
          readRegexp() {
            ...
            for (; r < this.length; ) {
              ...
              if (Di.has(c))
                c === 118 ? o.includes("u") && this.raise(p.IncompatibleRegExpUVFlags, h()) : c === 117 && o.includes("v") && this.raise(p.IncompatibleRegExpUVFlags, h()), o.includes(l) && this.raise(p.DuplicateRegExpFlags, h());
              else if (Q(c) || c === 92)
            ...
            if ((i = n) != null && i.error || this.match(47)) {
              ...
              if (l.node && this.maybeUnwrapTypeCastExpression(l.node).type === "ArrowFunctionExpression") {
                if (!l.error && !l.aborted)
                  return l.node.async && this.raise(g.UnexpectedTypeParameterBeforeAsyncArrowFunction, c), l.node;
                u = l.node;
              }
              if ((o = n) != null && o.node)
                return this.state = n.failState, n.node;
              if (u)
                return this.state = l.failState, u;
            ...
            switch (e.hasUnknownMembers = h, n) {
              ...
              default: {
                ...
                if (!u && !f && l >= d) {
                  ...
                  return this.raise(g.EnumInconsistentMemberValues, r, { enumName: i }), c();
              }
            }
          }
...
`) : i = String.fromCharCode(s), ++this.state.curLine, this.state.lineStart = this.state.pos, i;
          ...
          updateContext(e) {
            ...
            if (i === 56 && e === 142)
              ...
              this.state.canStartJSXElement = hi(i);
          }
        }, ot = class extends de {
          constructor(...t) {
        ...
        var Gi = (a) => class extends a {
          ...
          parseSubscript(e, s, i, r) {
            ...
            if (this.match(47) || this.match(51)) {
              let o, h = this.tsTryParseAndCatch(() => {
                ...
                if (l === 48 || l === 52 || l !== 10 && He(l) && !this.hasPrecedingLineBreak())
                  return;
          ...
          parseVarStatement(e, s, i = false) {
            ...
            for (let { id: o, init: h } of n.declarations)
              h && (s !== "const" || o.typeAnnotation ? this.raise(x.InitializerNotAllowedInAmbientContext, h) : Qi(h, this.hasPlugin("estree")) || this.raise(x.ConstInitiailizerMustBeStringOrNumericLiteralOrLiteralEnumReference, h));
            return n;
          }
          ...
          parseMaybeAssign(e, s) {
            ...
            let c, l, u;
            if (this.hasPlugin("jsx") && (this.match(142) || this.match(47))) {
              if (c = this.state.clone(), l = this.tryParse(() => super.parseMaybeAssign(e, s), c), !l.error)
                return l.node;
            ...
            if (!l && (jt(!this.hasPlugin("jsx")), u = this.tryParse(() => super.parseMaybeAssign(e, s), c), !u.error))
              return u.node;
            if ((r = l) != null && r.node)
          ...
          parseTypeOnlyImportExportSpecifier(e, s, i) {
            ...
            if (this.isContextual(93)) {
              ...
              if (this.isContextual(93)) {
                ...
                M(this.state.type) ? (l = false, h = s ? this.parseIdentifier() : this.parseModuleExportName()) : (c = true, o = d);
            } else
              M(this.state.type) && (c = true, s ? (o = this.parseIdentifier(true), this.isContextual(93) || this.checkReservedWord(o.name, o.loc.start, true, true)) : o = this.parseModuleExportName());
        ...
        var ct = class extends lt {
          ...
          parseMaybeUnary(t, e) {
            ...
            if (i) {
              ...
              if ((this.hasPlugin("v8intrinsic") ? He(h) : He(h) && !this.match(54)) && !this.isAmbiguousAwait())
          ...
          parseParenAndDistinguishExpression(t) {
            ...
            for (; !this.match(11); ) {
              ...
              if (this.match(21)) {
                ...
                if (l = this.state.startLoc, o.push(this.parseParenItem(this.parseRestBinding(), y)), !this.checkCommaAfterRest(41))
                  break;
              } else
          ...
          parseStatementContent(t, e) {
            ...
            switch (s) {
              ...
              case 100: {
                ...
                if (u !== 91 && (!r && this.hasFollowingLineBreak() || !this.chStartsBindingIdentifier(u, l) && u !== 123))
                  break;
              }
              case 75:
