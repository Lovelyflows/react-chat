import {
  ...
  stringify2,
  svg
} from "./chunk-QMN6VW55.js";
import {
  esm_default
} from "./chunk-IHA7KBER.js";
import {
  attention,
  autolink,
  blankLine,
  ...
  types,
  values
} from "./chunk-EGKAUHXN.js";
import {
  ok,
  unreachable,
  visit
} from "./chunk-4PAZRQVR.js";
import {
  require_jsx_runtime
} from "./chunk-AEC4YUPR.js";
import "./chunk-GBLXBTCA.js";
import {
  __commonJS,
  __export,
  __toESM
...
function one(state, node2, key) {
  if (node2.type === "element" || node2.type === "root") {
    ...
    if (node2.type === "element") {
      ...
      if (own.call(state.components, node2.tagName)) {
        const key2 = (
...
function table(state, node2) {
  ...
  if (rows.length > 0) {
    ...
    const start = pointStart2(node2.children[1]);
  ...
  function transform(node2, index2, parent) {
    ...
    if (node2.type === "element") {
      ...
      for (key in urlAttributes) {
        if (own5.call(urlAttributes, key) && own5.call(node2.properties, key)) {
